# Factcheck Agent Pipeline v3.1

## Обзор изменений v3.1

Версия 3.1 — рефакторинг пайплайна v3 с устранением ключевых проблем:

### Проблемы v3, которые исправлены в v3.1:
...
│   ├── orchestrator_v31.py              # Тонкий оркестратор v3.1
│   │
...
```bash
# Через main.py (добавьте аргумент --version v31)
python main.py --version v31

# Или напрямую
python -c "from agent.orchestrator_v31 import run_v31; run_v31()"
```
...
## Миграция с v3 на v3.1

1. **Оркестратор**: замените `FactcheckOrchestratorV3` на `FactcheckOrchestratorV31`
...
4. **Запуск**: используйте `--version v31` или прямой импорт
...
python -c "from agent.orchestrator_v31 import FactcheckOrchestratorV31; print('OK')"
```
